...
import cloud.mallne.geokit.geojson.serialization.LineStringSerializer
...
constructor(
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun fromJson(@Language("json") json: String): LineString =
         ...
         */
        @JvmStatic
        fun fromJsonOrNull(@Language("json") json: String): LineString? =
