...
class LineString @JvmOverloads constructor(
    ...
    companion object {
        @JvmStatic
        fun fromJson(json: String): LineString = fromJson(Json.decodeFromString(JsonObject.serializer(), json))

        @JvmStatic
        fun fromJsonOrNull(json: String): LineString? = try {
            fromJson(json)
        } catch (_: Exception) {
            null
        }
        ...
        @JvmStatic
        fun fromJson(json: JsonObject): LineString {
