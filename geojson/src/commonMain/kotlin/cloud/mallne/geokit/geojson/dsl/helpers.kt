 ...
 */
@GeoJsonDsl
inline fun buildMultiLineString(
 ...
 */
@GeoJsonDsl
inline fun <G : Geometry> buildGeometryCollection(
 ...
 */
@GeoJsonDsl
inline fun <G : Geometry?, P : @Serializable Any?> buildFeature(
    geometry: G,
    properties: P,
 ...
 */
@GeoJsonDsl
inline fun <G : Geometry?, P : @Serializable Any?> buildFeatureCollection(
 ...
 * @param bbox An optional bounding box for the point.
 */
fun GeometryCollectionBuilder<in Point>.addPoint(
 ...
 */
@GeoJsonDsl
inline fun MultiLineStringBuilder.addLineString(
 ...
 */
@GeoJsonDsl
inline fun GeometryCollectionBuilder<in LineString>.addLineString(
    builderAction: LineStringBuilder.() -> Unit
) {
    contract { callsInPlace(builderAction, InvocationKind.EXACTLY_ONCE) }
    add(LineStringBuilder().apply { builderAction() }.build())
 ...
 */
@GeoJsonDsl
inline fun GeometryCollectionBuilder<in Polygon>.addPolygon(
 ...
 */
@GeoJsonDsl
inline fun GeometryCollectionBuilder<in MultiPoint>.addMultiPoint(
 ...
 */
@GeoJsonDsl
inline fun GeometryCollectionBuilder<in MultiLineString>.addMultiLineString(
    builderAction: MultiLineStringBuilder.() -> Unit
) {
    contract { callsInPlace(builderAction, InvocationKind.EXACTLY_ONCE) }
 ...
 */
@GeoJsonDsl
inline fun GeometryCollectionBuilder<in MultiPolygon>.addMultiPolygon(
 ...
 */
@GeoJsonDsl
inline fun <T : Geometry> GeometryCollectionBuilder<in GeometryCollection<T>>.addGeometryCollection(
 ...
 */
@GeoJsonDsl
inline fun <G : Geometry?, P : @Serializable Any?> FeatureCollectionBuilder<in G, in P>.addFeature(
    geometry: G,
    properties: P,
    @BuilderInference builderAction: FeatureBuilder<G, P>.() -> Unit = {},
) {
 ...
 */
@GeoJsonDsl
inline fun <G : Geometry, P : @Serializable Any> FeatureCollectionBuilder<in G?, in P?>.addFeature(@BuilderInference builderAction: FeatureBuilder<G?, P?>.() -> Unit = {}) {
    contract { callsInPlace(builderAction, InvocationKind.EXACTLY_ONCE) }
 ...
 */
fun multiPointOf(vararg points: Point): MultiPoint = MultiPoint(*points)
 ...
 */
fun multiPolygonOf(vararg polygons: Polygon): MultiPolygon = MultiPolygon(*polygons)
 ...
 */
fun multiPointOf(vararg coordinates: Position): MultiPoint = MultiPoint(*coordinates)
 ...
 */
fun lineStringOf(vararg coordinates: Position): LineString = LineString(*coordinates)
 ...
 */
fun polygonOf(vararg coordinates: List<Position>): Polygon = Polygon(*coordinates)
 ...
 */
fun featureCollectionOf(): FeatureCollection<Nothing?, Nothing?> =
 ...
 */
fun <T : Geometry?, P : @Serializable Any?> featureCollectionOf(
