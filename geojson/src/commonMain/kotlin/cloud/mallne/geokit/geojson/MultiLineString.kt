...
import cloud.mallne.geokit.geojson.serialization.MultiLineStringSerializer
...
constructor(
     ...
     */
    operator fun get(index: Int): LineString = LineString(coordinates[index])
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun fromJson(@Language("json") json: String): MultiLineString =
         ...
         */
        @JvmStatic
        fun fromJsonOrNull(@Language("json") json: String): MultiLineString? =
