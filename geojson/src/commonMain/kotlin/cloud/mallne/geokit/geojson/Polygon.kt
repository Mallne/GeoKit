...
class Polygon @JvmOverloads constructor(
    ...
    companion object {
        @JvmStatic
        fun fromJson(json: String): Polygon = fromJson(Json.decodeFromString(JsonObject.serializer(), json))

        @JvmStatic
        fun fromJsonOrNull(json: String): Polygon? = try {
            fromJson(json)
        } catch (_: Exception) {
            null
        }
        ...
        @JvmStatic
        fun fromJson(json: JsonObject): Polygon {
