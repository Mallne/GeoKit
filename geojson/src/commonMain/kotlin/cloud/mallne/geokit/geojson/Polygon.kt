...
import cloud.mallne.geokit.geojson.serialization.PolygonSerializer
...
constructor(
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun fromJson(@Language("json") json: String): Polygon =
         ...
         */
        @JvmStatic
        fun fromJsonOrNull(@Language("json") json: String): Polygon? =
            GeoJson.decodeFromStringOrNull(json)

        @PublishedApi
        @JvmStatic
        internal fun toJson(polygon: Polygon): String = polygon.toJson()
    }
}
