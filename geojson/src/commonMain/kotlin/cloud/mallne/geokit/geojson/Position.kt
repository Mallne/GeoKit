...
import cloud.mallne.geokit.geojson.serialization.PositionSerializer
...
class Position internal constructor(internal val coordinates: DoubleArray) :
    Iterable<Double> {
    init {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun fromJson(@Language("json") json: String): Position =
         ...
         */
        @JvmStatic
        fun fromJsonOrNull(@Language("json") json: String): Position? =
            try {
                GeoJson.jsonFormat.decodeFromString(json)
