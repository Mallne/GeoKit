...
class MultiPoint @JvmOverloads constructor(
    ...
    companion object {
        @JvmStatic
        fun fromJson(json: String): MultiPoint = fromJson(Json.decodeFromString(JsonObject.serializer(), json))

        @JvmStatic
        fun fromJsonOrNull(json: String): MultiPoint? = try {
            fromJson(json)
        } catch (_: Exception) {
            null
        }
        ...
        @JvmStatic
        fun fromJson(json: JsonObject): MultiPoint {
